...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStorage = __webpack_require__(304);

	var _localStorage2 = _interopRequireDefault(_localStorage);

	var _ui = __webpack_require__(307);

	var _ui2 = _interopRequireDefault(_ui);

	var _colorData = __webpack_require__(308);

	var _colorData2 = _interopRequireDefault(_colorData);

	var _colorscheme = __webpack_require__(310);

	var _colorscheme2 = _interopRequireDefault(_colorscheme);

	var _preview = __webpack_require__(314);
	...
	var App = _vue2.default.extend({
	  ...
	  methods: {
	    ...
	    hideRegistry: function hideRegistry() {
	  ...
	  // Components
	  components: {
	    'app-colorscheme': _colorscheme2.default,
	    'app-preview': _preview2.default,
	    'app-registry': _registry2.default
	  },

	  watch: {
	    colorArray: function colorArray(colors) {
	      (0, _localStorage2.default)('colors', colors);
	    },

	    presets: function presets(_presets) {
	      (0, _localStorage2.default)('presets', _presets);
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stub = __webpack_require__(305);
	var tracking = __webpack_require__(306);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DEFAULT_COLORS = exports.COLOR_NAMES = undefined;
	...
	var _rgbaConvert = __webpack_require__(309);
	...
	var COLOR_NAMES = ['Default Foreground', 'Default Bold Foreground', 'Default Background', 'Default Bold Background', 'Cursor Text', 'Cursor Color', 'ANSI Black', 'ANSI Black Bold', 'ANSI Red', 'ANSI Red Bold', 'ANSI Green', 'ANSI Green Bold', 'ANSI Yellow', 'ANSI Yellow Bold', 'ANSI Blue', 'ANSI Blue Bold', 'ANSI Magenta', 'ANSI Magenta Bold', 'ANSI Cyan', 'ANSI Cyan Bold', 'ANSI White', 'ANSI White Bold'];

	var DEFAULT_COLORS = ["#bdb7a8", "#fff", "#171b1e", "#283539", "#171b1e", "#0ff", "#171b1e", "#313940", "#a41717", "#de130e", "#66760c", "#76b71e", "#b78d00", "#dfc400", "#1765bb", "#1d9efe", "#b32b79", "#e214f3", "#057aa0", "#1dabf8", "#bdb7a8", "#fff"];

	var ColorData = function () {
	  function ColorData(name, r, g, b) {
	  ...
	  _createClass(ColorData, [{
	    key: 'setValue',
	    value: function setValue(r, g, b) {
	      if (g === undefined) {
	        var _rgba = (0, _rgbaConvert2.default)(r);

	        var _rgba2 = _slicedToArray(_rgba, 3);
	    ...
	    get: function get() {
	      return _rgbaConvert2.default.hex(this.colorObj);
	    }
	  }, {
	    key: 'registryValue',
	    get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorField = __webpack_require__(311);

	var _colorField2 = _interopRequireDefault(_colorField);

	var _colorscheme = __webpack_require__(313);

	var _colorscheme2 = _interopRequireDefault(_colorscheme);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ColorScheme = _vue2.default.extend({
	  props: ['colors'],
	  template: _colorscheme2.default,
	  components: {
	    'app-color-field': _colorField2.default
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorField = __webpack_require__(312);

	var _colorField2 = _interopRequireDefault(_colorField);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ColorField = _vue2.default.extend({
	  props: ['color'],
	  template: _colorField2.default,
...
/***/ function(module, exports) {
	...
	module.exports = "<p class=\"color\">\n    <label for=\"{{ color.id }}\">{{ color.name }}:</label>\n    <span class=\"swatch\" :style=\"{ background: color.value }\" v-on:click=\"activate\"></span>\n    <input id=\"{{ color.id }}\" v-model=\"color.value\" placeholder=\"color\" type=\"color\">\n</p>\n";

/***/ },
/* 313 */
/***/ function(module, exports) {

	module.exports = "<div class=\"color-scheme\">\n    <app-color-field v-for=\"color in colors\" :color=\"color\"></app-color-field>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _preview = __webpack_require__(315);
	...
	var Preview = _vue2.default.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registry = __webpack_require__(317);

	var _registry2 = _interopRequireDefault(_registry);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Registry = _vue2.default.extend({
	  props: ['colors', 'presets'],
	  template: _registry2.default,
